...
/**
 * help_all - this displays all the possible builtin shellby commands
 */
void help_all(void)
{
...
/**
 * help_cd - this displays information on the shell by builtin command 'cd'
 */
void help_cd(void)
{
...
/**
 * help_exit - this displays information on the shell by builtin command 'exit'
 */
void help_exit(void)
{
