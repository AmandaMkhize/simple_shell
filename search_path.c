...
* @cmd: Parsed input command (updated with the full path if found)
...
* @pathValue: The directory containing the command
...
/**
* _getenv - Gets the value of the environment variable by name.
